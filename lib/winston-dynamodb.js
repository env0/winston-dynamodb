...
var DynamoDB = /** @class */ (function (_super) {
    ...
    function DynamoDB(options) {
        ...
        _this_1.db = new AWS.DynamoDB({ credentials: { accessKeyId: options.accessKeyId, secretAccessKey: options.secretAccessKey, sessionToken: options.sessionKey }, region: options.region });
        _this_1.AWS = AWS;
